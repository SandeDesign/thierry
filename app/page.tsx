...
export default function Home() {
  ...
  // vCard configuration - Easy to edit
  const contactInfo = {
    fullName: "Thierry Carli",
    telephone: "+31620983597",
    email: "thierry@itknecht.nl",
    organization: "IT Knecht | Festina Lente | Buddy",
    website: "https://fl-group.org"
  };

  const downloadVCard = () => {
    const vCardData = `BEGIN:VCARD
VERSION:3.0
N:${contactInfo.fullName.split(' ').reverse().join(';')};
FN:${contactInfo.fullName}
TEL;type=CELL;type=VOICE:${contactInfo.telephone}
...
END:VCARD`;
    ...
    a.download = 'Thierry-Contact.vcf';
